...
def load_models():
    ...
    net.eval()
    # net.load_state_dict(torch.load(r"C:\Users\ERICSSON\Documents\MPHIL CS\Y1S1\Image Processing\ML\DAI-Net\weights\DarkFaceZSDA.pth", map_location='cpu'))

    net.load_state_dict(torch.load('/content/drive/My Drive/DAI-Net/weights/DarkFaceFS.pth')) # Set the dir of your model weight
...
if __name__ == '__main__':
    ...
    def load_images():
        # imglist = glob.glob("C:/Users/ERICSSON/Documents/MPHIL CS/Y1S1/Image Processing/ML/DAI-Net/dataset/DarkFace_Train/*.png")
        imglist = glob.glob("/content/drive/My Drive/DAI-Net/dataset/DarkFace_Train/*.png")
        return imglist
